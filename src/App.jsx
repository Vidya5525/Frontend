...
function App() {
 ...
 useEffect(()=>{
   const fetchUser = async()=>{
    try {
     const response =  await axios.get("https://backend-h73h.onrender.com/api/v1/user/patient/me",{withCredentials:true});
   ...
   const fetchAdmin = async()=>{
    try {
     const response =  await axios.get("https://backend-h73h.onrender.com/api/v1/user/admin/me",{withCredentials:true});
     setIsAuthenticated(true);
